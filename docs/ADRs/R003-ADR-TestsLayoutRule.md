...
`tests/rules/layout/tests_layout_rule_tests.rs` — 21 tests, written before the
...
`tests/finding/parsing/registry_parser_tests.rs` — 13 tests — covers the naming of every item
